...
const char *cmd_set_prop_map[DSI_CMD_SET_MAX] = {
	...
	"mi,mdss-dsi-low-tmp-on-mode-command",
	"mi,mdss-dsi-low-tmp-off-mode-command",
...
const char *cmd_set_state_map[DSI_CMD_SET_MAX] = {
	...
	"mi,mdss-dsi-low-tmp-on-mode-command-state",
	"mi,mdss-dsi-low-tmp-off-mode-command-state",
...
const char *cmd_set_update_map[DSI_CMD_UPDATE_MAX] = {
	...
	"mi,mdss-dsi-low-tmp-on-mode-command-update",
#endif
};
...
int dsi_panel_enable(struct dsi_panel *panel)
{
	...
	panel->mi_cfg.low_tmp_state = false;
	panel->mi_cfg.low_tmp_index = 0;
	...
	mi_dsi_panel_set_dbi_by_temp_N2_locked(panel, panel->mi_cfg.feature_val[DISP_FEATURE_DBI]);
