...
/**
 * enum sde_wfd_wcg_mode: WCG mode of the WB connector
 * WFD_WCG_DISABLE: WB connector disabled WCG
 * WFD_WCG_ENABLE: WB connector enabled WCG
 */
enum sde_wfd_wcg_mode {
	WFD_WCG_DISABLE,
	WFD_WCG_ENABLE
};
