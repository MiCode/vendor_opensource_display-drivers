...
###########################################################
# Add rely to use the functions of virtual proximity
LCT_TP_SYMBOLS := $(DISPLAY_BLD_DIR)/../touch-drivers/Module.symvers
KBUILD_OPTIONS += KBUILD_EXTRA_SYMBOLS="$(LCT_TP_SYMBOLS)"
