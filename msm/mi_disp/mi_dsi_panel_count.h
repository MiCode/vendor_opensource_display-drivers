...
struct mi_dsi_panel_count {
	...
	bool panel_fullscreen_aod_count_enable;
	u64 boottime;
	u64 bootRTCtime;
	u64 bootdays;
	u64 panel_active;
	...
	u64 fullscreen_aod_daily_times;
	u64 fullscreen_aod_daily_active;
	u64 fullscreen_aod_daily_longest;
