...
/*mafr(multi-area framerate) debug*/
ssize_t mi_dsi_display_set_debug_mafr(void *display, char *buf);
...
ssize_t mi_dsi_display_get_debug_param(void *display, char *buf, size_t size);

int mi_dsi_display_set_te_width(void *display, u32 buf);
